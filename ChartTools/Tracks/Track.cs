...
public abstract record Track : IEmptyVerifiable
{
    ...
    #region File reading
    #region Single file
    [Obsolete($"Use {nameof(ChartFile.ReadInstrument)} with a difficulty set.")]
    ...
    [Obsolete($"Use {nameof(ChartFile.ReadInstrumentAsync)} with a difficulty set.")]
    ...
    [Obsolete($"Use {nameof(ChartFile.ReadDrums)} with a difficulty set.")]
    ...
    [Obsolete($"Use {nameof(ChartFile.ReadDrumsAsync)} with a difficulty set.")]
    ...
    #region Directory
    [Obsolete($"Use {nameof(ChartFile.ReadInstrument)} with a {nameof(DifficultySet)} and {nameof(Metadata.Formatting)}.")]
    ...
    [Obsolete($"Use {nameof(ChartFile.ReadInstrumentAsync)} with a {nameof(DifficultySet)} and {nameof(Metadata.Formatting)}.")]
    ...
    [Obsolete($"Use {nameof(ChartFile.ReadDrums)} with a {nameof(DifficultySet)} and {nameof(Metadata.Formatting)}.")]
    ...
    [Obsolete($"Use {nameof(ChartFile.ReadDrumsAsync)} with a {nameof(DifficultySet)} and {nameof(Metadata.Formatting)}.")]
